...
#Inputs
selected_trial = input$trial_no_rel_val
alpha_value_A= input$alpha_A_rel_val
alpha_value_B = input$alpha_B_rel_val
alpha_value_C = input$alpha_C_rel_val
beta_value= input$beta_rel_val
...
p <-grid1 + draw_label(label= 'True discrimination', x= 0.5 ,y=0.94, color = "#d73925", size= 16)
