...
#Inputs
selected_trial = input$trial_no_downshift_unblk
alpha_value_A= input$alpha_A_downshift_unblk
alpha_value_B = input$alpha_B_downshift_unblk
beta_value_1= input$beta_1_downshift_unblk
beta_value_2 = input$beta_2_downshift_unblk
...
beta_2<- c(rep(beta_value_2, n_trial)) 
