...
alpha_value_A= input$alpha_A_comp_cond
alpha_value_B = input$alpha_B_comp_cond
beta_value = input$beta_comp_cond
selected_trial = input$trial_no_comp_cond

prev_alpha = input$alpha_A_comp_cond
prev_beta =  input$beta_comp_cond
